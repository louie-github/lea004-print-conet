...
@section('content')
    <main class="main-content mt-0 vh-100 d-flex justify-content-around align-items-center">
        <div class="w-75 d-flex flex-column align-items-center">
            ...
            <form id="pinForm" action="" method="post" class="my-3">
                @for ($i = 0; $i < 6; $i++)
            ...
            <script>
                ...
                let inputs = document.querySelectorAll("#pinForm input");
            ...
            <div class="mt-6 d-flex align-items-center">
                <a class="mx-4 btn btn-primary btn-lg h5" href="/kiosk/pin">Submit</a>
                <a class="mx-4 btn btn-secondary btn-lg h5" href="/kiosk/pin">Cancel</a>
            </div>
        </div>
    </main>
@endsection
