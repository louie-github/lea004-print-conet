                        ...
                        <ul class="list-group">
                            ...
                            <li class="list-group-item border-0 d-flex p-4 mb-2 bg-gray-100 border-radius-lg">
                                <div class="d-flex flex-column">
                                    <a class="btn btn-link p-0 m-0 text-start"  href="{{ route('document.show', ['document' => $document->id]) }}">  <h6 class="mb-3 text-sm " ><i class="fas fa-file-csv text-lg me-1"></i> {{$document->name}}</h6> </a>
                        ...
                        <ul class="list-group">
                            ...
                            <li class="list-group-item border-0 d-flex justify-content-between ps-0 mb-2 border-radius-lg">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="d-flex flex-column">
                                        <h6 class="mb-1 text-dark text-sm">{{$transaction->document->name}} (<span class="text-xs">{{$transaction->created_at}}</span>)</h6>
